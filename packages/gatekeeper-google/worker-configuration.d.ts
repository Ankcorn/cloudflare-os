/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1edf04b44a4d0f48e523d51520ca8d13)
// Runtime types generated with workerd@1.20251109.0 2025-11-01 enable_ctx_exports,experimental
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/google");
		durableNamespaces: "UserAccount" | "GmailGatekeeperImpl";
	}
	interface Env {
		CLIENT_ID: string;
		CLIENT_SECRET: string;
		DUMMY_UserAccount: DurableObjectNamespace<import("./src/google").UserAccount>;
		DUMMY_GmailGatekeeperImpl: DurableObjectNamespace<import("./src/google").GmailGatekeeperImpl>;
	}
}
