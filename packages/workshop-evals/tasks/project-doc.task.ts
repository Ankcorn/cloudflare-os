 ...
 *
 * So the outcome under test is "I asked for a doc and got a Doc", verified two ways that do not care
 * how the agent got there: the workpiece is presented as a `document` output, and it answers the
 * Docs RPC contract. An agent that hand-rolls a bespoke notes gadget fails both, correctly — the
 * user asked for a doc and would not be able to use it like one.
 *
