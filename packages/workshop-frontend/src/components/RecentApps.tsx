...
export default function RecentApps() {
  ...
  useEffect(() => {
    ...
    authenticatedApi.listGadgets().then((list) => {
      if (cancelled) return
      const sorted = [...list].sort((a, b) => b.lastActive.getTime() - a.lastActive.getTime())
    ...
    return (
      <section className="w-full max-w-2xl mx-auto">
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-sm font-medium text-kumo-default">Recent gadgets</h2>
        </div>
    ...
    return (
      <section className="w-full max-w-2xl mx-auto">
        <div className="text-center py-8 text-sm text-kumo-danger">
          Unable to load your gadgets. Check your connection and try refreshing.
        </div>
      </section>
    )
  }
    ...
    return (
      <section className="w-full max-w-2xl mx-auto">
        <div className="text-center py-8 text-kumo-inactive text-sm">
          No gadgets yet. Create your first one above!
        </div>
      </section>
    )
  }
