...
//
// The GatekeeperModal renders this image at full tile size (h-10 w-10 with object-cover). The
// built-in vendor logos render as inline SVGs at `size={18}` (~45% of the 40px tile). To match
// that visual weight, we wrap the source SVG in extra viewBox padding so the logomark occupies
// ~45% of the rendered canvas, with the rest transparent.
//
// The source SVG uses a 512x512 viewBox. We wrap it in a 1120x1120 viewBox (offset by
// (-304, -304)) so the logo occupies 512/1120 ≈ 46% of the rendered area, matching the other
// vendor icons.
const HOMEASSISTANT_LOGO_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="-304 -304 1120 1120">\
...
<body>
  <div class="card">
    ...
    <p>Provide the URL of your Home Assistant instance and a long-lived access token. Gadgets will use these to read entity states and control devices.</p>
    ...
    <form method="POST" action="${escapeAttr(params.actionUrl)}">
      ...
      <details>
        ...
        <ol>
          ...
          <li>Give it a name like "Gadgets", then copy the token and paste it above.</li>
        </ol>
      </details>
...
<body style="font-family: system-ui, sans-serif; padding: 2rem; text-align: center;">
  ...
  <p>Home Assistant has been linked to Gadgets. You may close this tab.</p>
</body>
</html>`;
...
<body style="font-family: system-ui, sans-serif; padding: 2rem; text-align: center;">
  ...
  <p>This connection link is invalid or has expired. Please return to the Gadgets Workshop and start over.</p>
</body>
</html>`;
