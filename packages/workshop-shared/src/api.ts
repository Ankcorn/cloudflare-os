...
export type GadgetMetadata = {
  ...
  /**
   * True when the gadget has observed data marked as restricted (see
   * `ObservationDescription.containsRestrictedData`). Such gadgets can no longer be shared with
   * additional users or links.
   */
