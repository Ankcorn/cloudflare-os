...
// by upload-release.mjs before its manifest PUT — so this single manifest copy IS the atomic
// publish (manifest-last protocol: the deploy service scans only releases/).
//
